...
<div class="w-full">
    <!-- Desktop Table View -->
	<div class="hidden lg:block overflow-x-auto bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-2xl shadow-2xl">
						...
						<td class="px-6 py-5">
							<div class="flex items-center gap-4">
								...
								<div class="flex flex-col gap-0.5">
									...
									<span class="text-[11px] font-semibold text-slate-500 font-mono tracking-tighter">{robot.id}</span>
								</div>
							</div>
						</td>
						<td class="px-6 py-5">
